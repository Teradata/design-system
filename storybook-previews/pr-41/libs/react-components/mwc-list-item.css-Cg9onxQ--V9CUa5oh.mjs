import { s as e, d as n, o as a, P as p, i as m, H as s, a as h } from "./query-DSO61t36-C1M9Gebp.mjs";
import { T as g, N as _ } from "./ripple-handlers-BAdg-fJB-BM-4KCUA.mjs";
import { v as d } from "./observer-DQ8OfVDQ-Df_oiWMx.mjs";
...
class i extends m {
  constructor() {
    super(...arguments), this.value = "", this.group = null, this.tabindex = -1, this.disabled = !1, this.twoline = !1, this.activated = !1, this.graphic = null, this.multipleGraphics = !1, this.hasMeta = !1, this.noninteractive = !1, this.selected = !1, this.shouldRenderRipple = !1, this._managingList = null, this.boundOnClick = this.onClick.bind(this), this._firstChanged = !0, this._skipPropRequest = !1, this.rippleHandlers = new _(() => (this.shouldRenderRipple = !0, this.ripple)), this.listeners = [
      {
        target: this,
        eventNames: ["click"],
        cb: () => {
